...
import { Star, Shield, Server, Cloud, Lock, Headphones, Building2, Database, Globe } from "lucide-react";
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">
                <span className="text-foreground font-semibold">+200</span> entreprises nous font confiance
              </span>
            </motion.div>
